...
class MainActivityNuevoUsuario : AppCompatActivity() {
    var corr : String=""
    var nom : String=""
    var pwd : String=""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_main_nuevo_usuario)

    }

        fun btnRegistrar_clic(view: View) {
